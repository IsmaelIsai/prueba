...
class Fpdf_cm extends BaseController
{
	...
	{	$session = session();
        ...
        {	include('conec.php');
		   ...
		   if(count($guia)>=1){
			...
			$sql=mysqli_query($conexion, "SELECT turno,ID_SER ,t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name1'");
			...
			$sql2=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name2'");
			$date2=mysqli_fetch_array($sql2);
			}
			if(count($guia)>=3){

			$sql3=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name3'");
			$date3=mysqli_fetch_array($sql3);
			}
			if(count($guia)>=4){

			$sql4=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name4'");
			$date4=mysqli_fetch_array($sql4);
			}
			if(count($guia)>=5){

			$sql5=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name5'");
			$date5=mysqli_fetch_array($sql5);
			}
			if(count($guia)>=6){

			$sql6=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name6'");
			$date6=mysqli_fetch_array($sql6);
			}
			if(count($guia)>=7){

			$sql7=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name7'");
			$date7=mysqli_fetch_array($sql7);
			}
			if(count($guia)>=8){

			$sql8=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name8'");
			$date8=mysqli_fetch_array($sql8);
			}
			if(count($guia)>=9){

			$sql9=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name9'");
			$date9=mysqli_fetch_array($sql9);
			}
			if(count($guia)>=10){

			$sql10=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name10'");
			$date10=mysqli_fetch_array($sql10);
			}
			if(count($guia)>=11){

			$sql11=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name11'");
			$date11=mysqli_fetch_array($sql11);
			}
			if(count($guia)>=12){

			$sql12=mysqli_query($conexion, "SELECT t_rcm.SSA,desc_produc,presentacion,c_solicitada FROM `t_rcm`INNER JOIN t_productos ON t_productos.SSA=t_rcm.SSA WHERE ID_RCM='$folio' AND t_productos.SSA ='$name12'");
			...
			$fpdf->SetXY(10,10);
			$fpdf->Cell(0,30,'RECETARIO COLECTIVO DE MEDICAMENTOS', 0, 0, 'C');
