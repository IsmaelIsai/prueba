...
class S_medicamento extends BaseController
{
	...
	{	$session = session();
	    ...
	    $builder->select('ID_RCM,desc_produc,t_rcm.SSA,c_solicitada,cant_tot,c_surtida');
	    $builder->join('t_productos','t_rcm.SSA=t_productos.SSA');
	    $builder->where('ID_RCM', $SSA_pro);
	    $query = $builder->get();
	    //SELECT ID_RCM,t_rcm.SSA,c_solicitada,SUM(cantidad),c_surtida FROM `t_rcm` INNER JOIN `t_inventario` ON t_rcm.SSA=t_inventario.SSA WHERE ID_RCM ='20210211101456' AND t_rcm.SSA='010.000.0106.00' AND f_expira>'2021-02-19'
	   ...
	   if(count($guia)==1){
		    ...
		    $builder->join('t_inventario','t_rcm.SSA=t_inventario.SSA');
		    $builder->where('ID_RCM', $SSA_pro);
		    $builder->where('t_rcm.SSA', $name1);
		...
		if(count($guia)==10){
		    ...
		    $builder->join('t_inventario','t_rcm.SSA=t_inventario.SSA');
		    $builder->where('ID_RCM', $SSA_pro);
		    $builder->where('t_rcm.SSA', $name10);
		    $builder->where('f_expira>', date("Y-m-d"));
		    $query = $builder->get();
		    $consul=$query->getResultArray();
		    foreach($consul as $consull){
		...
		if(count($guia)==11){
		    ...
		    $builder->join('t_inventario','t_rcm.SSA=t_inventario.SSA');
		    $builder->where('ID_RCM', $SSA_pro);
		    $builder->where('t_rcm.SSA', $name11);
		    $builder->where('f_expira>', date("Y-m-d"));
		    $query = $builder->get();
		    $consul=$query->getResultArray();
		    foreach($consul as $consull){
		...
		if(count($guia)==12){
		    ...
		    $builder->join('t_inventario','t_rcm.SSA=t_inventario.SSA');
		    $builder->where('ID_RCM', $SSA_pro);
		    $builder->where('t_rcm.SSA', $name12);
		    $builder->where('f_expira>', date("Y-m-d"));
		    $query = $builder->get();
		    $consul=$query->getResultArray();
		    foreach($consul as $consull){
		...
		echo view('header');
		echo view('Salidas/medicamento', $dataing);
		echo view('footer');	
