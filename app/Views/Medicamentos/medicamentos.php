...
<div class="card shadow mb-6">
                ...
                <h5 class="m-1 font-weight-bold text-info float-left">Salida de medicamentos</h5>
                <div>
                </div>
                  </div>
                  <form action="<?php echo base_url(); ?>/Medicamentos/insertar" name="despachar" autocomplete="off" method="POST">
                <div class="card-body"> 
                            <div class="row"> 
