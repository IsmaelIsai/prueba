        ...
        <div class="col-md-12 ">
            ...
            <div class="card shadow mb-3">
                ...
                <h5 class="m-1 font-weight-bold text-info float-left">Entrega de material de curación</h5>
                ...
                <button href="" class="btn btn-info btn-icon-split float-right" data-placement="top">
                    <span class="icon text-white-1" aria-hidden="true"></span><span class="text">Regresar</span>
                      ...
                      <form action="<?php echo base_url(); ?>/S_curacion/actualizar" autocomplete="off" method="POST">
                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <tr>
                            <td><input type="int"  name="<?php echo $RECETA ?>" id="<?php echo $RECETA ?>" value="<?php echo $dataingreso['ID_RCMC'] ?>" readonly></td>
