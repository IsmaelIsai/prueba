            ...
            <div class="card shadow mb-3">
                ...
                <button href="" class="btn btn-info btn-icon-split float-right" data-placement="top">
                    <span class="icon text-white-1" aria-hidden="true"></span><span class="text">Regresar</span>
                      ...
                      <form action="<?php echo base_url(); ?>/S_receta/actualizar" autocomplete="off" method="POST">
                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <tr>
                            <td><input type="int"  name="<?php echo $RECETA ?>" id="<?php echo $RECETA ?>" value="<?php echo $dataingreso['ID_RECETA'] ?>" readonly></td>
