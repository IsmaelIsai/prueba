	...
	<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  <li class="nav-item active">
		...
		<div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item" href="<?php echo base_url(); ?>/usuarios"><i class="fas fa-users"></i> Usuario</a>
          </div>
        </div>
			  </li>
	  ...
	  <li class="nav-item active">
		...
		<i class="fas fa-sign-out-alt"></i>
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url(); ?>/receta_med"><i class="fas fa-notes-medical"></i> Receta médica</a>
			<a class="collapse-item" href="<?php echo base_url(); ?>/curacion"><i class="fas fa-first-aid"></i> Curación</a>
			<a class="collapse-item" href="<?php echo base_url(); ?>/medicamentos"><i class="fas fa-capsules"></i> Medicamentos</a>
          </div>
	  </li>
	  ...
	  <!-- Nav Item - Tables -->
	  <li class="nav-item active">
		<a class="nav-link" href="<?php echo base_url("Medvencidos");?>">
		<i class="fas fa-prescription-bottle-alt"></i>
		  <span>Medicamentos vencidos</span></a>
	  </li>
	  <li class="nav-item active">
		<a class="nav-link" href="<?php echo base_url("Semaforo");?>">
		<i class="fas fa-prescription-bottle-alt"></i>
		  <span>Semaforo de caducidad</span></a>
	  </li>
